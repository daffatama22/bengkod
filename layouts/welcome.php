...
<head>
    ...
    <style>
        body {
            background-image:url("./150353596_10463016.jpg");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="">Poliklinik</a>
    ...
    <?php if (!$muncul) : ?>
        <section class="py-5 border-bottom" id="features">
            <div class="container px-5 my-5">
                <div class="row gx-5 d-flex text-center">
                    <div class="col-lg-6 mb-5 mx-auto">
                        <div class="card card-custom p-4">
                            <h2 class="h4 fw-bolder">Registrasi Pasien</h2>
                            <p>Form Registrasi Pasien</p>
                            <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk/pages/auth/register.php">
                    ...
                    <div class="col-lg-6 mb-5 mx-auto">
                        <div class="card card-custom p-4">
                            ...
                            <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk/pages/auth/login.php">
